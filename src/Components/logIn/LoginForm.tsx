...
export const LoginForm = ({loginToggle}:any) => {
  return (
    <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              ...
              className="text-sm flex gap-2 font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <span className="cursor-pointer font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</span>
                  </p>
            </div>
                    </form>
  )
